...
const addOption = (field) => field.options.push({ id: Date.now(), text: `新選項 ${field.options.length + 1}` });
  ...
  <div class="fields-config">
    ...
    <div class="config-layout">
      <div class="edit-panel">
        <div class="section-title">自定義欄位 (可拖拽 ⠿ 排序)</div>
            ...
            <div class="field-card-container" :class="{ 'is-hidden-field': field.isHidden }">
              ...
              <div class="field-card-main">
                <div class="field-info">
                  ...
                  <input v-model="field.label" :disabled="field.isFixed" class="field-label-input" placeholder="欄位名稱" />
                ...
                <div class="field-ctrl">
                  <label class="toggle-btn" :class="{ 'is-active': field.isHidden }">
                    ...
                    <span>{{ field.isHidden ? '🙈 隱藏' : '👁️ 顯示' }}</span>
                  </label>
                  ...
                  <button v-if="!field.isFixed" @click="removeField(index)" class="delete-btn">✕</button>
                </div>
              </div>
        ...
        <div class="add-control">
          <input v-model="newFieldLabel" @keyup.enter="addField" placeholder="新增欄位..." class="add-input" />
